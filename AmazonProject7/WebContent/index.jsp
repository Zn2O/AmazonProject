  ...
  <div id="header">
    ...
    <div id="menu_tab">
      <div class="left_menu_corner"></div>
        ...
        <li class="divider"></li>
        <li><a href="Index.html" class="nav2">Produits</a></li>
        <li class="divider"></li>
        <li><a href="Index.html" class="nav3">Promotions</a></li>
        <li class="divider"></li>
        <li><a href="Index.html" class="nav4">Mon compte</a></li>
        <li class="divider"></li>
        <li><a href="connexion.jsp" class="nav4">Se connecter</a></li>
        <li class="divider"></li>
        <li><a href="Index.html" class="nav5">Panier</a></li>
        <li class="divider"></li>
        <li><a href="contact.html" class="nav6">contact</a></li>
        <li class="divider"></li> 
        <li class="currencies">Convertir
          <select>
